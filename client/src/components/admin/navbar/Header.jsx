        ...
        <nav className="bg-white py-2 md:py-4 w-100">
            <div className="container px-4 mx-auto md:flex md:items-center">
                ...
                <div className="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
                    <a href="#" className="p-2 lg:px-4 md:mx-2 text-neutral-800 text-center border border-transparent bg-indigo-50 rounded hover:bg-indigo-100 hover:text-indigo-700 transition-colors duration-300">{isUser.data.data.username || "loading..."}</a>
